...
export const projectsData: Project[] = [
  {
    ...
    description: "Real-time video analytics platform for retail environments with multi-person detection, foot traffic heatmap, and queue monitoring.",
    tags: ["Python", "YOLO11", "FastAPI", "React", "WebSocket", "OpenCV"],
    image: "/default.png",
    slug: "retail-intelligence-system",
    role: "Full Stack Developer",
    duration: "Mar 2026 - Apr 2026",
    challenge: "Build a real-time analytics system capable of processing video streams to track foot traffic, monitor checkout queues, and estimate demographics without storing any facial embeddings for privacy.",
    solution: "Developed a Python/FastAPI backend utilizing YOLO11 and ByteTrack for robust multi-person detection and tracking. Connected to a React dashboard via WebSockets to stream real-time metrics and video feeds.",
    impact: "Enabled retail store managers to optimize staff allocation based on real-time queue length alerts and understand store hot-spots through dynamic heatmaps.",
    keyFeatures: [
      "Real-time multi-person tracking with YOLO11 & ByteTrack",
      "Foot traffic heatmap generation",
      "Checkout queue monitoring with threshold alerts",
      "Privacy-preserving demographic estimation",
      "Live dashboard with WebSocket streaming",
    ],
    architecture: "FastAPI backend running YOLO11 models for computer vision tasks. Real-time WebSocket connection to a React/Vite frontend using Recharts for data visualization.",
    liveUrl: null,
    playStoreUrl: null,
    apkUrl: null,
    repoUrl: "https://github.com/Asadell/smart-retail-analytics",
  },
  {
    id: 102,
    title: "ADMA - Agentic DevOps Monitor",
    description: "AI-powered server monitoring system that detects anomalies and performs automated root cause analysis.",
    tags: ["Go", "ASP.NET Core", "NATS", "PostgreSQL", "Docker", "LLM"],
    image: "/default.png",
    slug: "adma-devops-monitor",
    role: "Full Stack Developer",
    duration: "Apr 2026 - May 2026",
    challenge: "Traditional server monitoring requires significant manual investigation to identify root causes. The challenge was to automate anomaly detection and triage across Docker containers and databases using LLMs.",
    solution: "Built a distributed monitoring system using Go and ASP.NET Core communicating via NATS. Implemented an automated root cause analysis pipeline using Claude LLM, complete with a safety gate system for action execution.",
    impact: "Drastically reduced mean time to resolution (MTTR) by providing automated, context-aware diagnostics and safely vetted remediation steps.",
    keyFeatures: [
      "AI-powered anomaly detection",
      "Automated root cause analysis pipeline with Claude LLM",
      "Iterative evidence gathering via Docker & PostgreSQL inspection",
      "Action candidate generation with safety gate system",
      "Distributed architecture using NATS",
    ],
    architecture: "Microservices architecture with Go and ASP.NET Core. NATS for event-driven messaging. PostgreSQL for telemetry data. LLM integration for agentic diagnostic workflows.",
    liveUrl: null,
    playStoreUrl: null,
    apkUrl: null,
    repoUrl: null,
  },
  {
    id: 103,
    title: "Resummy App",
    description: "Mobile app for CV building, analysis, translation, and AI-powered interview simulation with STAR-method feedback.",
    tags: ["Flutter", "Gemini AI", "Firebase", "SQLite", "Clean Architecture"],
    image: "/default.png",
    slug: "resummy-app",
    role: "Mobile Full Stack Developer",
    duration: "Jan 2026 - Feb 2026",
    challenge: "Deliver a comprehensive, AI-driven mobile app capable of real-time CV analysis and mock interviews, while overcoming API quota limits and ensuring offline capability.",
    solution: "Designed an offline-first Flutter application using SQLite and Firebase synchronization. Implemented a round-robin system across 51 Gemini API keys to handle high-throughput requests without bottlenecks.",
    impact: "Provided job seekers with a powerful tool for resume enhancement and interview preparation, ensuring smooth user experience even in offline scenarios.",
    keyFeatures: [
      "AI-powered CV analysis and translation",
      "Interview simulation with STAR-method feedback",
      "Offline-first architecture with automatic sync",
      "Gemini API round-robin system for high throughput",
      "Clean Architecture implementation",
    ],
    architecture: "Flutter frontend with Clean Architecture. Offline-first local SQLite database that syncs to Firebase Firestore when online. Custom API key rotation strategy for LLM access.",
    liveUrl: null,
    playStoreUrl: null,
    apkUrl: null,
    repoUrl: "https://github.com/Asadell/resummy_app",
  },
  {
    id: 1,
    title: "Reading Manager App",
    description:
      "Smart reading assistant with AI-powered Q&A, summaries, and semantic search using Gemini API",
    ...
    impact:
      "Helped users comprehend complex documents 3x faster with AI-powered summaries and contextual answers. Students and researchers reported significant improvement in study efficiency.",
    keyFeatures: [
    ...
    liveUrl: null,
    playStoreUrl: "https://play.google.com/store/apps/details?id=com.bfour.rima_app",
    apkUrl: null,
    repoUrl: null,
  },
  {
    ...
    description:
      "IoT-based livestock monitoring system with RFID integration for real-time health tracking",
    ...
    impact:
      "Enabled farmers to monitor livestock health 24/7, reducing manual checking time by 70%. Early detection of health issues improved animal welfare and reduced veterinary costs.",
    keyFeatures: [
  ...
  },
  {
    ...
    description:
      "Complete school management system with attendance, scheduling, and online examination features",
    ...
    impact:
      "Streamlined school administration processes, reduced manual paperwork by 80%, and improved communication between teachers, students, and parents. Online exam system saved teachers hours of grading time.",
    keyFeatures: [
...

  {
    ...
    description:
      "Organization management app with Firebase RBAC and real-time QR code attendance system",
    ...
    impact:
      "Enabled organizations to manage members efficiently with 90% reduction in manual attendance tracking. Security features prevented attendance fraud completely.",
    keyFeatures: [
  ...
  },
  {
    ...
    description:
      "Mobile ML app for house price prediction using TensorFlow Lite with user-contributed training data",
    tags: ["Flutter", "TensorFlow Lite", "Firebase ML"],
    image: "/homepredictor.png",
    ...
    impact:
      "Provided users with instant house price estimates with 85% accuracy. User-contributed data improved model performance by 15% over three months.",
    keyFeatures: [
  ...
  },
  {
    ...
    description:
      "Online UTBK tryout platform migrated from Laravel to Golang & Next.js for better performance",
    ...
    impact:
      "Successfully improved platform performance by 40%, reduced server load, and enhanced maintainability. Platform now handles thousands of concurrent users efficiently with improved response times.",
    keyFeatures: [
  ...
  },
  {
    ...
    description:
      "Location-based hotel booking platform with Google Maps integration and instant reservation",
    ...
    impact:
      "Simplified hotel search and booking process, reducing booking time by 60%. Users appreciated the location-based search and instant confirmation features.",
    keyFeatures: [
...

  {
    ...
    description:
      "User management platform with achievement tracking and activity visualization dashboard",
    ...
    impact:
      "Centralized member management system improved organizational efficiency. Achievement tracking motivated members and increased engagement by 45%.",
    keyFeatures: [
  ...
  },
  {
    ...
    description:
      "Association website with dynamic content management for agenda, articles, and community profiles",
    tags: ["Laravel", "MySQL", "REST API"],
    ...
    impact:
      "Streamlined content management for ITDS organization. Reduced content update time by 70% and improved website maintainability.",
    keyFeatures: [

...
export const projectDetails: ProjectDetail[] = [
  {
    ...
    description: "Online UTBK tryout platform migrated from Laravel to Golang & Next.js for better performance and maintainability",
  ...
  },
  {
    ...
    title: "D-Cows Livestock Monitoring System",
    description: "IoT-based livestock monitoring platform to track animal health, activity, and environmental conditions in real-time",
  ...
  },
  {
    ...
    description: "Complete school management system with attendance, scheduling, class communication, and online examination features",
  ...
  },
  {
    ...
    description: "Smart reading assistant with AI-powered contextual Q&A, summaries, and semantic search from PDF documents",
  ...
  },
  {
    ...
    title: "House Price Predictor App",
    description: "Mobile ML application for house price prediction using TensorFlow Lite with user-contributed training data via Firebase",
    image: "/house-predictor.png",
    role: "Mobile Full Stack Developer",
    duration: "May 2025",
    tags: ["Flutter", "TensorFlow Lite", "Firebase ML", "Machine Learning"],
    challenge:
  ...
  },
  {
    ...
    description: "Location-based hotel booking platform with Google Maps integration and instant reservation system",
    image: "/hotel-booking.png",
    role: "Mobile Full Stack Developer",
    duration: "Apr 2025",
    tags: ["Flutter", "Google Maps API", "Firebase", "Geolocation"],
    challenge:
  ...
  },
  {
    ...
    description: "Organization management app with Firebase RBAC and real-time QR code attendance system with time-sensitive codes",
    image: "/vorka-app.png",
    role: "Mobile Full Stack Developer",
    duration: "Dec 2024",
  ...
  },
  {
    ...
    description: "Comprehensive user management platform with achievement tracking, growth visualization, and activity data dashboard",
  ...
  },
  {
    ...
    title: "HIMIT ITDS Association Website",
    description: "Dynamic association website with content management for agenda, articles, galleries, community, and cabinet profiles",
